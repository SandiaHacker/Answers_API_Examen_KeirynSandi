...
public partial class AnswersDbContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        => optionsBuilder.UseSqlServer("SERVER=.;DATABASE=AnswersDB;INTEGRATED SECURITY=FALSE;User Id=answers;Password=123;TrustServerCertificate=True");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AskStatusId).HasName("PK__AskStatu__0329362C3ECC9DAF");
        ...
        {
            entity.HasKey(e => e.CountryId).HasName("PK__Country__10D160BFE4F62272");
        ...
        {
            entity.HasKey(e => e.Idconfig).HasName("PK__General__3E2AEF2A79DF0232");
        ...
        {
            entity.HasKey(e => e.LikeId).HasName("PK__Like__A2922CF4261753E5");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__User__1788CCACC901E205");
        ...
        {
            entity.HasKey(e => e.UserRoleId).HasName("PK__UserRole__3D978A555EAD0EE1");
        ...
        {
            entity.HasKey(e => e.UserStatusId).HasName("PK__UserStat__A33F541A1FF3392E");
